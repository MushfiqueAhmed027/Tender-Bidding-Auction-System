     ...
     /** * Where to redirect users after registration. * * @var string */
      ...
      /** * Create a new controller instance. * * @return void */
       ...
       public function __construct() { 
         ...
         *  * * @param array $data * @return \Illuminate\Contracts\Validation\Validator */
         ...
         protected function validator(array $data) { 
            ...
            //     } 
                ...
                public function showMultiuserRegisterForm() { 
                ...
                /** * @param array $data * * @return mixed */
                 ...
                 protected function create(array $data) { 
                    ...
                    //     } 
                        ...
                        protected function createMultiuser(Request $request) { 
                             $this->validator($request->all())->validate(); 
                             Multiuser::create([ 
                                 'name' => $request->name,
                                  'email' => $request->email, 
