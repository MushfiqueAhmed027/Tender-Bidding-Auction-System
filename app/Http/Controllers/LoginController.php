     ...
     /** * Create a new controller instance. * * @return void */
      ...
      public function __construct() {
        ...
        //   } 
          ...
          public function showMultiuserLoginForm() {
                          
            return view('auth.login', ['url' => 'multiuser']);
        ...
        public function multiuserLogin(Request $request) { 
            ...
            if (Auth::guard('multiuser')->attempt(['email' => $request->email, 'password' => $request->password], $request->get('remember'))) 
                              
            { 
                                  return redirect()->intended('/multiuser'); 
                }
