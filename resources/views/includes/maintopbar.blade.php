		...
		<span class="m-nav__link-text">
			<img class="m-topbar__language-selected-img" src="{{asset('assets/app/media/img/flags/020-flag.svg')}}">
                ...
                <div class="m-dropdown__wrapper">
                    ...
                    <div class="m-dropdown__inner">
                        <div class="m-dropdown__header m--align-center"
                             style="background: url({{asset('assets/app/media/img/misc/flagsquick_actions_bg.jpg')}}); background-size: cover;">
                                ...
                                <ul class="m-nav m-nav--skin-light">
                                    ...
                                    <li class="m-nav__item">
                                        ...
                                        onclick="event.preventDefault();
                                           ...
                                           class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Logout</a> <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                            @csrf
                                        </form>
                                    </li>
                                </ul>
