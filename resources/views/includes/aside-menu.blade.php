...
<div
        id="m_ver_menu"
        class="m-aside-menu  m-aside-menu--skin-lightdark  m-aside-menu--submenu-skin-lightdark "
        ...
        <li class="nav-header">
            <div class="dropdown profile-element"> 
                <span>
                    ...
                    <img src="{{asset('assets/app/media/img//users/109.png')}}" 
                    class="img-circle" style="max-width: 64px; margin-left: 81px;" alt="Richard Williams">
                 </span><br>
                <a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false">
                    <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold" style="max-width: 64px; margin-left: 85px;">{{ Auth::user()->name }}</strong>
                        <br>
                    </span> <span class="text-muted text-xs block" style="max-width: 64px; margin-left: 81px;">My Account <b class="caret"></b></span> </span> </a>
...
<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
    <ul class="m-menu__subnav">
        <li class="m-menu__item " aria-haspopup="true"><a href="/user"
            class="m-menu__link "><i
class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
class="m-menu__link-text">User</span></a></li>
<li class="m-menu__item " aria-haspopup="true"><a href="/permission"
    class="m-menu__link "><i
class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
class="m-menu__link-text">Permission</span></a></li>
<li class="m-menu__item " aria-haspopup="true"><a href="/role"
    class="m-menu__link "><i
class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
class="m-menu__link-text">Role</span></a></li>
    </ul>
        </li>
        ...
        <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"><a href="javascript:;"
            class="m-menu__link m-menu__toggle"
            title="Tor"><i
class="m-menu__link-icon fa fa-bullseye"></i><span
class="m-menu__link-text">EOI / TOR</span><i
class="m-menu__ver-arrow la la-angle-left"></i></a>
<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
    <ul class="m-menu__subnav">
        @can('tor-create')
        <li class="m-menu__item " aria-haspopup="true"><a href="/admin/tor/list"
            class="m-menu__link "><i
class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
class="m-menu__link-text">Create</span></a></li>
@endcan
<li class="m-menu__item " aria-haspopup="true"><a href="/admin/tor"
    class="m-menu__link "><i
class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
class="m-menu__link-text">View</span></a></li>
</ul>
</li>
...
<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"><a href="javascript:;"
    class="m-menu__link m-menu__toggle"
    title="Template"><i
        class="m-menu__link-icon fa fa-window-restore"></i><span
        class="m-menu__link-text">Template</span><i
        class="m-menu__ver-arrow la la-angle-left"></i></a>
        <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
            <ul class="m-menu__subnav">
                @can('template_create')
                <li class="m-menu__item " aria-haspopup="true"><a href="/admin/template/create_step1"
                    class="m-menu__link "><i
        class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
        class="m-menu__link-text">Create</span></a></li>
        @endcan
        <li class="m-menu__item " aria-haspopup="true"><a href="/admin/template"
            class="m-menu__link "><i
        class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
        class="m-menu__link-text">View</span></a></li>
        </ul>
        ...
        <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"><a href="javascript:;"
            class="m-menu__link m-menu__toggle"
            title="Tender"><i
class="m-menu__link-icon fa fa-spinner"></i><span
class="m-menu__link-text">Tender</span><i
class="m-menu__ver-arrow la la-angle-left"></i></a>
<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
    <ul class="m-menu__subnav">
        @can('tender-create')
        <li class="m-menu__item " aria-haspopup="true"><a href="/admin/tender/create"
            class="m-menu__link "><i
class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
class="m-menu__link-text">Create</span></a></li>
@endcan
<li class="m-menu__item " aria-haspopup="true"><a href="/admin/tender"
    class="m-menu__link "><i
class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
class="m-menu__link-text">View</span></a></li>
    </ul>
        ...
        <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"><a href="/admin/tor/pdf"
            class="m-menu__link m-menu__toggle"
            title="E-Tender"><i
        class="m-menu__link-icon fa fa-barcode"></i><span
        class="m-menu__link-text">E-Tender</span></a>
        ...
        <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"><a href="javascript:;"
                        class="m-menu__link m-menu__toggle"
                        title="Company"><i
            class="m-menu__link-icon fa fa-th"></i><span
            class="m-menu__link-text">Company</span><i
            class="m-menu__ver-arrow la la-angle-left"></i></a>
            <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                <ul class="m-menu__subnav">
                    @can('company_create')
                    <li class="m-menu__item " aria-haspopup="true"><a href="/admin/company/create_step1"
                        class="m-menu__link "><i
            class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
            class="m-menu__link-text">Create</span></a></li>
            @endcan
            <li class="m-menu__item " aria-haspopup="true"><a href="/admin/company"
                class="m-menu__link "><i
            class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
            class="m-menu__link-text">View</span></a></li>
         </ul>
                ...
                <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"><a href="javascript:;"
                    ...
                    class="m-menu__link-text">Bidder</span><i
                    class="m-menu__ver-arrow la la-angle-left"></i></a>
                    <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                        <ul class="m-menu__subnav">
                            @can('bidder_create')
                            <li class="m-menu__item " aria-haspopup="true"><a href="/admin/bidder/create_step1"
                                class="m-menu__link "><i
                    class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
                    class="m-menu__link-text">Create</span></a></li>
                    @endcan
                    <li class="m-menu__item " aria-haspopup="true"><a href="/admin/bidder"
                        class="m-menu__link "><i
                    class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
                    class="m-menu__link-text">View</span></a></li>
                    </ul>
                ...
                <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"><a href="/admin/report"
                    class="m-menu__link m-menu__toggle"
                    title="Bidder"><i
                    class="m-menu__link-icon fa fa-id-card"></i><span
                    class="m-menu__link-text">Report</span></a>
