...
<script>
    ...
    var csrfData = {"formatted":{"csrf_token_name":"c849b178c2b2cec6149ed830b10edd6c"},"token_name":"csrf_token_name","hash":"c849b178c2b2cec6149ed830b10edd6c"};
                                        ...
                                        @endisset
                                         ...
                                         <div class="col-md-6">
                                             <div class="form-group" app-field-wrapper="company">
                                                 ...
                                                 <input type="text" id="company" name="company" class="form-control" autofocus="1" value="{{ old('company') }}">
                                             </div> 
                                             <div class="form-group" app-field-wrapper="first_name">
                                                <label for="first_name" class="control-label">First Name</label>
                                                <input type="text" id="first_name" name="first_name" class="form-control" autofocus="1" value="{{ old('first_name') }}">
                                            </div>
                                            <div class="form-group" app-field-wrapper="last_name">
                                                <label for="last_name" class="control-label">Last name</label>
                                                <input type="text" id="last_name" name="last_name" class="form-control" autofocus="1" value="{{ old('last_name') }}">
                                            </div>
                                            <div class="form-group row">
                                             ...
                                             <div class="select-placeholder form-group form-group-select-input-groups_in[] input-group-select">
                                                 ...
                                                 <div class="input-group input-group-select select-groups_in[]" app-field-wrapper="groups_in[]">
                                                     <select id="groups_in[]" name="groups_in[]" class="selectpicker  _select_input_group" 
                                                     multiple="1" data-actions-box="1" data-width="100%" data-none-selected-text="Nothing selected" 
                                                     data-live-search="true">
                                                         <option value="2">Garments Compant</option>
                                                         <option value="1">IT Company</option>
                                                     </select>
                                                     <div class="input-group-addon">
                                                         <a href="#" data-toggle="modal" data-target="#customer_group_modal">
