...
@section('content')
    ...
    <div class="m-portlet m-portlet--tab">
        ...
        <!--begin::Form-->
        <form class="m-login__form m-form" method="POST" action="{{ route('role.store') }}">
             @csrf
            <div class="m-portlet__body">
                ...
                {{-- <div class="form-group m-form__group">
                    <label for="role_name" class="col-md-4 col-form-label text-md-left">{{ __('Role Name') }}</label>
                            ...
                            <div class="col-md-8">
                                <input id="role_name" type="role_name" class="form-control @error('role_name') is-invalid @enderror" name="role_name" value="{{ old('role_name') }}" required autocomplete="role_name">
