			  ...
			  <div class="m-wizard m-wizard--5 m-wizard--success" id="m_wizard">
                    ...
                    <!--begin: Form Wizard Head -->
						...
						<div class="m-wizard__form">
							...
							-->
							<form class="m-form m-form--label-align-left- m-form--state-" id="m_form" method="post" action="/admin/tor/create_step4" enctype="multipart/form-data">
								@csrf   
								<input type="hidden" value="4" id="next_step"  name="next_step">
					
                                    <div class="m-form__section m-form__section--first">
                                        <div class="m-form__heading">
                                            <h3 class="m-form__heading-title">Other Conditions  </h3>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input id="submitted_on" type="date" class="form-control m-input @error('submitted_on') is-invalid @enderror"  name="submitted_on" value="{{ old('submitted_on') }}" required autocomplete="submitted_on" autofocus >
                                                @error('submitted_on')
                                        ...
                                        <div class="form-group m-form__group row">
                                            <label class="col-form-label col-lg-3 col-sm-12">*Acknowledgement</label>
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <textarea class="form-control" id="acknowledgement" name="acknowledgement">"{{$templates->first('acknowledgement')}}"</textarea> 
                                        ...
                                        <div class="form-group m-form__group row">
                                            <label class="col-form-label col-lg-3 col-sm-12">*Tenderer Signature</label>
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <textarea class="form-control" id="tenderer_signature" name="tenderer_signature">"{{$templates->first('tenderer_signature')}}"</textarea> 
                                            ...
                                            <div class="form-group m-form__group row">
                                                <label class="col-form-label col-lg-3 col-sm-12">*Note</label>
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <textarea class="form-control" id="note" name="note">"{{$templates->first('note')}}"</textarea> 
                                                        <script src="{{ asset('vendor/unisharp/laravel-ckeditor/ckeditor.js') }}"></script>
                                                        <script>
