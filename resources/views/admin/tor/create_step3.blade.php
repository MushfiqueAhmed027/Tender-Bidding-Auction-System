			  ...
			  <div class="m-wizard m-wizard--5 m-wizard--success" id="m_wizard">
                    ...
                    <!--begin: Form Wizard Head -->
						...
						<div class="m-wizard__form">
							...
							-->
							<form class="m-form m-form--label-align-left- m-form--state-" id="m_form" method="post" action="/admin/tor/create_step3" enctype="multipart/form-data">
								@csrf   
								<input type="hidden" value="3" id="next_step"  name="next_step">
					
                                    <div class="m-form__section m-form__section--first">
                                        <div class="m-form__heading">
                                            <h3 class="m-form__heading-title">Financial Offer </h3>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            @inject('templates', 'App\Template')
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <textarea class="form-control" id="financial_offer" name="financial_offer">"{{$templates->first('financial_offer')}}"</textarea> 
