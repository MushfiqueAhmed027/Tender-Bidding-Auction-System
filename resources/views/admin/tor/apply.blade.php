...
<div class="m-portlet">
    ...
    <!--begin::Form-->
    <form class="m-login__form m-form" method="POST" action="{{ route('tor.submit') }}">
        @csrf
        <div class="m-portlet__body">
            <div class="m-form__section m-form__section--first">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <input type="name" class="form-control m-input" name="name" value="Application for {{$tor->name}}">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-12">
                        @foreach($tor as $tors)
                        <textarea class="form-control" id="scope_of_work" name="scope_of_work">{{$tor->scope_of_work}}</textarea> 
